...
namespace CustomComponents.Lib {
    public partial class ControlTemperatura : UserControl {
        ...
        private void SetValorActual(float valorActual) {
            ...
            lbValorTemperatura.Text = $"{valorActual}°C";
        ...
        private void canvas_Paint(object sender, PaintEventArgs e) {
            ...
            /* Dibujar fan */
            g.DrawImageUnscaled(Resources.temperature_130px, new Point(canvas.Width / 2 - 65, canvas.Height / 2 - 65));
            ...
            using (var progressBarPen = new Pen(Color.FromArgb(182, 60, 58), 10)) {
